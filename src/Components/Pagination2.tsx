...
const PexelsGallery2 = () => {
  ...
  const {
    ...
    onSuccess: (data: { photos: never[]; total_results: number }) => {
      const initialPhotos = data?.photos || [];
      const totalPagesCount = Math.ceil(data?.total_results / perPage);
